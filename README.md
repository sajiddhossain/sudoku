...
## How to Play
1. Download the executable from the [GitHub Releases](https://github.com/sajiddhossain/sudoku/releases/download/v1.0.0/SudokuForge-macOS.zip) page and extract it
